      ...
      <div className="mt-5">
        ...
        <section className="">
          <div className={styles.container}>
            <div class={styles.containerr}>
              ...
              >
                <div>
                  ...
                  <h4 class="d-inline card-title" style={{}}>
                     Facebook Ads
                  </h4>
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
            ...
            <div class={styles.containerr}>
              <a href="#modal9" data-toggle="modal" data-target="#modal9">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Create high-converting descriptions and headlines for your
                    Google Search Ads
                  </p>
                </div>
              </a>
            ...
            <div class={styles.containerr}>
              <a href="#modal10" data-toggle="modal" data-target="#modal10">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Write scroll-stopping copy for your Twitter Ads.
                  </p>
                </div>
              </a>
            </div>
        ...
        <section>
          <div className={styles.container}>
              ...
              <a href="#modal2" data-toggle="modal" data-target="#modal2">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Creating Engaging Copy For Your Facebook Posts To Maximize
                    Organic Reach.
                  </p>
                </div>
              </a>
            ...
            <div class={styles.containerr}>
              <a href="#modal11" data-toggle="modal" data-target="#modal11">
                <div>
            ...
            <div class={styles.containerr}>
              <a href="#modal12" data-toggle="modal" data-target="#modal12">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Cut Through The Noise By Generating Compelling Copy For Your
                    LinkedIn posts.
                  </p>
                </div>
              </a>
        ...
        <section>
          <div className={styles.container}>
              ...
              <a href="#modal3" data-toggle="modal" data-target="#modal3">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Generate Witty Tweets To Keep Your Folowers Engaged.
                  </p>
                </div>
              </a>
            </div>
              ...
              <a href="#modal4" data-toggle="modal" data-target="#modal4">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Generate stellar descriptions to step up your Pinterest
                    game.
                  </p>
                </div>
              </a>
            ...
            <div class={styles.containerr}>
              <a href="#modal5" data-toggle="modal" data-target="#modal5">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Write smart Youtube titles and descriptions to help viewers
                    find your videos
                  </p>
                </div>
              </a>
        ...
        <section>
          <div className={styles.container}>
            <div class={styles.containerr}>
              <a href="#modal6" data-toggle="modal" data-target="#modal6">
                <div>
                  <i
                    class="far fa-envelope-open"
                    style={{ color: "black" }}
                  ></i>
                  <h4 class="d-inline card-title" style={{ fontSize: "16px" }}>
                    Cold Email
                  </h4>
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Create Powerful, Convincing Emails To Attract Potential
            ...
            <div class={styles.containerr}>
              <a href="#modal7" data-toggle="modal" data-target="#modal7">
                <div>
                  <i
                    class="far fa-envelope-open"
                    style={{ color: "black" }}
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Have something amazing for your customers? Let them know!
                    Write an awesome email about a new product or an exciting
                    promotion.
                  </p>
                </div>
              </a>
        ...
        <section>
          <div div className={styles.container}>
            <div class={styles.containerr}>
              <a href="#modal8" data-toggle="modal" data-target="#modal8">
                <div>
                  ...
                  <p
                    class={`${styles.jss365} ${styles.jss918} ${styles.jss367}`}
                  >
                    Generate Text Messages That Actually Sell.
                  </p>
                </div>
              </a>
            </div>
